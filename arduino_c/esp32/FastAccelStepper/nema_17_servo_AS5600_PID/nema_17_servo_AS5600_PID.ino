...
int microstepping = 4;
int formula = ((stepsPerRev * microstepping) / 360);
...
void loop(){    
  ...
  //encoderValue = encoder.getAngle();

  //REV = map (User_Input, 0, motionAngle, 0, PPR); // mapping degree into pulse
